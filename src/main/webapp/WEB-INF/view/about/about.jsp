		                            ...
		                            <div class="swiper-slide">
		                                <div class="item">
		                                    ...
		                                    <ul>
		                                    	<li>
		                                            <strong>11</strong>
		                                            <span>경기도일자리재단 여성 친화 일촌기업 협약</span>
		                                        </li>
		                                    	<li>
		                                            <strong>07</strong>
		                                            <span>(주)나이스디앤비 기업신용평가등급 인증(등급:B0)</span>
		                                        </li>
		                                    </ul>
		                                </div>
		                            </div>
		                            ...
		                            <div class="swiper-slide">
                                        <div class="item">
                                            ...
                                            <ul>
                                                <li>
                                                    <strong>12</strong>
                                                    <span>(주)나이스디앤비 우수기술기업 인증서 획득(등급:T4)</span>
                                                </li>
                                                <li>
                                                    <strong>05</strong>
                                                    <span>중소벤처기업진흥공단 '창업도착패키지' R&D사업 선정투자유치</span>
                                                </li>
                                                <li>
                                                    <strong>03</strong>
                                                    <span>중소벤처기업진흥공단 '일자리창출촉진' R&D사업 선정투자유치</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
		...
		<div class="content_wrap partners evt txt_move">
		    <div class="wrap">
		        <div class="layout_wrap evt">
		            ...
		            <div class="right">
		                <ul class="evt list">
		                   <li><img src="../images/partner01.png" alt="서울대공원"></li> 
		                   <li><img src="../images/partner02.png" alt="현대해상"></li> 
		                   <li><img src="../images/partner03.png" alt="롯데카드"></li> 
		                   <li><img src="../images/partner04.png" alt="신한은행"></li> 
		                   <li><img src="../images/partner05.png" alt="BNK부산은행"></li> 
		                   <li><img src="../images/partner06.png" alt="한국경제TV"></li> 
		                   <li><img src="../images/partner07.png" alt="미래에셋"></li> 
		                   <li><img src="../images/partner08.png" alt="서울특별시"></li> 
		                   <li><img src="../images/partner09.png" alt="대한적십자사"></li> 
		                   <li><img src="../images/partner10.png" alt="TheK손해보험"></li> 
		                   <li><img src="../images/partner11.png" alt="국립중앙의료원"></li> 
		                   <li><img src="../images/partner12.png" alt="한국무역협회"></li> 
		                   <li><img src="../images/partner13.png" alt="AIG손해보험"></li> 
		                   <li><img src="../images/partner14.png" alt="현대오토에버"></li> 
		                   <li><img src="../images/partner15.png" alt="LG CNS"></li> 
		                   <li><img src="../images/partner16.png" alt="롯데정보통신"></li> 
		                   <li><img src="../images/partner17.png" alt="PCN"></li> 
		                   <li><img src="../images/partner18.png" alt="농심"></li> 
		                   <li><img src="../images/partner19.png" alt="넷마블"></li> 
		                   <li><img src="../images/partner20.png" alt="투비소프트"></li> 
		                   <li><img src="../images/partner21.png" alt="인스웨이브시스템즈"></li> 
		                   <li><img src="../images/partner22.png" alt="동양네트워크"></li>
		                   <%-- <li><img src="../images/partner23.png" alt="펜타브리드"></li>
						   <li><img src="../images/partner24.png" alt="핑거"></li>--%> 
		                   <li><img src="../images/partner25.png" alt="동북아역사재단"></li> 
		                   <li><img src="../images/partner26.png" alt="조인트리"></li> 
		                   <li><img src="../images/partner27.png" alt="G2E"></li>
		                </ul>
		            </div>
		        </div>
		    </div>
