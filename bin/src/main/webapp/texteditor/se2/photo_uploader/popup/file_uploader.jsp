...
String path = request.getSession().getServletContext().getRealPath("/") + "upload/texteditor"; // 이미지가 저장될 주소 (운영)
//String path = "c:/upload/texteditor";  이미지가 저장될 주소 (로컬)
String filename = "";
...
<%
	...
	try {
		...
		MultipartRequest multi=new MultipartRequest(request, path, 30*1024*1024, "UTF-8", new DefaultFileRenamePolicy());
