...
<!-- 						<option value="sort03">제목</option> -->
            ...
            <table>
                ...
                <thead>
                 ...
                 <tbody>
                	...
                	<c:forEach var="n" items="${recruitList}" varStatus="st">
                    <tr>
                        ...
                        <td class="title"><a href="javascript:fn_viewRecruit(${n.board_no});">${n.title}</a></td>
                        <td>
	    ...
	    <div class="btn-area01">
        	<a href="javascript:fn_deleteRecruit();" class="btn02">삭제</a>
        	<a href="/admin/recruit/recruit_write.do" class="btn01">글쓰기</a>
        </div>
    </div>
