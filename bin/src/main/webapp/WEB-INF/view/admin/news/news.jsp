...
<!-- 						<option value="sort03">제목</option> -->
                ...
                <thead>
                 ...
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td class="title"><a href="javascript:fn_viewNews(${n.board_no});">${n.title}</a></td>
                        <td>
                        ...
                        <!-- <td class="modify"><a href="/admin/news/news_edit.do?board_no=${n.board_no}">수정</a></td> -->
                    </tr>
                    </c:forEach>
                </c:if>
                <c:if test="${fn:length(newsList) == 0}">
	    ...
	    <div class="btn-area01">
        	...
        	<a href="javascript:fn_deleteNews();" class="btn02">삭제</a>
        	<a href="/admin/news/news_write.do" class="btn01">글쓰기</a>
        </div>
    </div>
